...
{fas}`envelope` [feilong@sc.edu](mailto:feilong@sc.edu) | {fab}`google-scholar` [Google Scholar](https://scholar.google.com/citations?user=2_X6hk8AAAAJ) | {fab}`orcid` [0000-0002-6838-3971](https://orcid.org/0000-0002-6838-3971) <br>
{fab}`bluesky` [@feilong.bsky.social](https://bsky.app/profile/feilong.bsky.social) | {fab}`twitter` [@mafeilong](https://twitter.com/mafeilong) | {fab}`github` [feilong](https://github.com/feilong) 
...
## Ziyi Ding
**Graduate Student** <br>
{fas}`envelope` [ziyi.ding@sc.edu](mailto:ziyi.ding@sc.edu) | {fab}`google-scholar` [Google Scholar](https://scholar.google.com/citations?user=mettqmQAAAAJ) | {fab}`orcid` [0000-0002-9391-8907](https://orcid.org/0000-0002-9391-8907) <br>
...
{fas}`envelope` [mran@mailbox.sc.edu](mailto:mran@mailbox.sc.edu) | {fab}`google-scholar` [Google Scholar](https://scholar.google.com/citations?user=w_hZoo0AAAAJ&hl=en&oi=ao) <br>
{fab}`bluesky` [@avaaaaran.bsky.social](https://bsky.app/profile/avaaaaran.bsky.social) | {fab}`twitter` [@ran_mengxin](https://twitter.com/ran_mengxin) | {fab}`github` [AvARan2001](https://github.com/AvARan2001) 
...
(ian)=
## Ian Attmore
**Provost Undergraduate AI Fellow** <br>
{fas}`envelope` [iattmore@email.sc.edu](mailto:iattmore@email.sc.edu) | {fab}`linkedin` [LinkedIn](https://www.linkedin.com/in/ian-attmore/) | {fab}`github` [IanAtt](https://github.com/IanAtt)
