...
{fas}`envelope` [mran@mailbox.sc.edu](mailto:mran@mailbox.sc.edu) \
{fab}`google-scholar` [Google Scholar](https://scholar.google.com/citations?user=w_hZoo0AAAAJ&hl=en&oi=ao) \
{fab}`bluesky` [@avaaaaran.bsky.social](https://bsky.app/profile/avaaaaran.bsky.social) | {fab}`twitter` [@ran_mengxin](https://twitter.com/ran_mengxin) \
{fab}`github` [AvARan2001](https://github.com/AvARan2001) 
